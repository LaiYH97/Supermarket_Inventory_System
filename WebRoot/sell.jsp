...
<html>
  ...
  <div class="biankuang">
  <div class="zhengti">
    <form action="sell_conn.jsp" method="post">
    <table border="0" width="138" hight="252">
    	...
    	<div><tr><td>商品销售量</td></tr><td><input type="text" name="Gsales" style="width: 300px;"></td></div>
    	<tr align="center">
    		<td colspan="2">
    			<input class="but" type="submit" value="出  售">&nbsp;&nbsp;&nbsp;&nbsp;
